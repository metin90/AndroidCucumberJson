package utils.CustomizedReport;
...
public class CustomizedEmailableReport implements IReporter {
    ...
    public static String[] stackTrace(Throwable var0, boolean var1) {
        return new String[]{shortStackTrace(var0, var1), longStackTrace(var0, var1)};
    }
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
                               String outdir) {
        outdir=System.getProperty("user.dir")+"/test-output/";
        try {
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
		...
		// customized-emailable-report.html
        return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, "CustomizedReport_Test_Automation_Results.html"))));
            ...
            for (ITestNGMethod method : getMethodSet(tests, suite)) {
                ...
                for (ITestResult testResult : tests.getResults(method)) {
                    ...
                    if(hasThrowable){
                        ...
                        String str = stackTrace(exception, true)[0];
    ...
    protected void generateExceptionReport(Throwable exception,
        ...
        out.print(stackTrace(exception, true)[0]);
        out.println("</div>");
    }
    ...
    protected void startHtml(PrintWriter out) {
        ...
        out.println("<META http-equiv=\"content-type\" content=\"text/html; charset=x-mac-turkish<code>\"/>");
